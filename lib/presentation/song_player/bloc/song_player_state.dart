...
class SongPlayerLoaded extends SongPlayerState {
  ...
  SongPlayerLoaded({
    ...
    required this.isFavorite, // ✅ ADD TO CONSTRUCTOR
  });
  ...
  SongPlayerLoaded copyWith({
    ...
    return SongPlayerLoaded(
      ...
      isFavorite: isFavorite ?? this.isFavorite, // ✅ COPY VALUE
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is SongPlayerLoaded &&
          ...
          isFavorite == other.isFavorite; // ✅ CHECK FAVORITE TOO
  ...
  int get hashCode =>
      ...
      isFavorite.hashCode; // ✅ HASH FAVORITE TOO
}
